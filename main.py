...
from acm import imrotate, plot_snakes, CNN_B, snake_graph, plot_for_figure, draw_poly,derivatives_poly,draw_poly_fill
...
def epoch(n,i,mode):
    ...
    if do_plot:
        ...
        plot_for_figure(snake, snake_hist, thisGT, mapE, mapA, mapB, mapK, \
                grads_arrayE, grads_arrayA, grads_arrayB, grads_arrayK, batch, batch_mask)
        plt.show()
    return iou,snake
